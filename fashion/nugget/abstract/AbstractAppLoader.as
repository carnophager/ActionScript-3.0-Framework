package fashion.nugget.abstract
{
	...
	public class AbstractAppLoader extends View
	{
		...
		protected var _glossary : Glossary;
		 ...
		 * @constructor
		 */
		public function AbstractAppLoader(mainFile : String)
		{
			_mainFile = mainFile;
		...
		protected function setupLoader() : void
		{
			...
			_loader.append(new XMLLoader(Nugget.basepath + "/assets/xml/navigation.xml", { name:"xml_navigation" }));
			_loader.append(new SWFLoader(Nugget.basepath + "/" + _mainFile, { name:"swf_main" }));
		...
		protected function setupGlossary() : void
		{
			_glossary = Glossary.getInstance();
