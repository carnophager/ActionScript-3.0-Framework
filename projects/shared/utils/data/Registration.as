package projects.shared.utils.data
{
	 ...
	 * 	_registration = new Registration(REGISTRATION_URL);
	 * 
	 * _registration.addEventListener(Registration.UNFILLED_DATA_EVENT	, onUnfilledData);
	 * _registration.addEventListener(Registration.INFO_SENT_EVENT		, onInfoSent);
	 * 
	 * _registration.addField(_graphic.input_name			, Registration.INPUT_TEXT, Parameters.REGISTRATION_VARAIBLES[0]		, true	, TextField(_graphic.input_name).text		);
	 * _registration.addField(_graphic.input_mail			, Registration.INPUT_TEXT, Parameters.REGISTRATION_VARAIBLES[1]		, true	, TextField(_graphic.input_mail).text		);
	 * 
	...
	public class Registration extends EventDispatcher
	{
		...
		public function submitRegistration() : void
		{
			...
			trace('url_varaibles:', _url_variables);
